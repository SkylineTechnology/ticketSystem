                ...
                <div class="main-page">
                    ...
                    <div class="row widgettable">
                        <div style="width:100%; height: 100%; margin-left:0px;  margin-top: 30px !important;" class="col-md-12 general-grids grids-right widget-shadow">
                            <h4 class="title2">CHANGE PASSWORD</h4>
                                ...
                                <form method="POST" action="" role="form">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input required="" name="op" type="password" class="form-control" id="exampleInputPassword1" placeholder="Old Password">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">New Password</label>
                                            <input required="" name="np" type="password" class="form-control" id="exampleInputPassword1" placeholder="New Password">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Confirm New Password</label>
                                            <input required="" name="cp" type="password" class="form-control" id="exampleInputPassword1" placeholder="Confirm New Password">
                                        </div>
